...
* fix: c语言参数类型无空格 [#294](https://github.com/OBKoro1/koro1FileHeader/issues/294)

### [V4.8.3]

* feat: 拦截异步错误以及增加错误日志功能
* feat: 匹配php的类型声明, [#285](https://github.com/OBKoro1/koro1FileHeader/issues/285)
...
* fix: 修复c语言添加关键字导致参数解析失败的问题 #[#289](https://github.com/OBKoro1/koro1FileHeader/issues/289)
* fix: 修复获取符号未考虑文件的情况
